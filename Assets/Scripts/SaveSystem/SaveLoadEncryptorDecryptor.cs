...
public class SaveLoadEncryptorDecryptor
{
        ...
        {
            return EncryptStringToBytes_Aes(plaintext, _encryptionKey, _encryptionIV);
        }
        
        [Button]
        public string DecryptStringFromBytes_Aes(byte[] cipherText)
        {
            return DecryptStringFromBytes_Aes(cipherText, _encryptionKey, _encryptionIV);
        }
